...
public class FollowedEvents  extends Stage {

    public FollowedEvents(Service service, User user) {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/views/FollowedEvents.fxml"));
        Pane layout;
        try {
            layout = loader.load();
