...
public class PaginateUsersStage extends Stage {

    public PaginateUsersStage(Service service, User user) {
        FXMLLoader loader = new FXMLLoader();
        loader.setLocation(getClass().getResource("/views/PaginateUsers.fxml"));
        Pane layout;
        try {
            layout = loader.load();
